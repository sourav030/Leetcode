<h2><a href="https://www.geeksforgeeks.org/problems/geeks-and-the-string--170645/1?page=1&category=Stack&difficulty=Medium&status=unsolved&sortBy=latest">Geeks And The String</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Our geek loves to play with strings, Currently, he is trying to reduce the size of a string by recursively removing all the consecutive duplicate pairs. In other words, He can apply the below operations any number of times.</span></p>
